...
use Acr\Ftr\Controllers\Fit\Entity\GetUBLListRequest;
use Acr\Ftr\Controllers\Fit\Entity\GetUBLRequest;
use Acr\Ftr\Controllers\Fit\Entity\UserListsRequest;
use Acr\Ftr\Controllers\Fit\Entity\UserListItem;

class FitBulutController
{
    private $SERVICE_TEST_URL = "https://earsivwstest.fitbulut.com/ClientEArsivServicesPort.svc";
    ...
    {
        $this->ch = curl_init($this->SERVICE_TEST_URL);
        curl_setopt($this->ch, CURLOPT_SSL_VERIFYPEER, 0);
        curl_setopt($this->ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($this->ch, CURLOPT_TIMEOUT, 10);
        curl_setopt($this->ch, CURLOPT_POST, true);
        curl_setopt($this->ch, CURLOPT_USERPWD, 'Hb2iphtC' . ":" . 'HC%GKmP4');
    }
    ...
    public function setWSAuth($wsUser = 'Hb2iphtC', $wsPass = 'HC%GKmP4')
    {
    ...
    public function mukellefSorgu($TCKN_VKN = 36019069004, $gonderenBirim, $gelenBirim)
    {
