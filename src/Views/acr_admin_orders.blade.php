...
' : '<span style="color:  #357c14;"> ÖDENDİ</span>';
                    ...
                    <tr>
                        ...
                        <td><input onclick="order_active(<?php echo $order->id; ?>)" id="order_input_{{$order->id}}" <?php  echo $order->active == 1 ? 'checked' : 0; ?> style="width: 32px; height: 32px; cursor:pointer;"
                                   name="siparis"
                                   value="{{$order->id}}"
                                   type="checkbox"/></td>
                    </tr>
